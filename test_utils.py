...
class TestDB_add_update(unittest.TestCase):
    ...
    def test_set_last_crawled_in_repo(self):
        ...
        db_utils.set_last_crawled_in_repo(this_repo.repo_id, now, 1) 
    ...
    def test_set_last_crawled_in_user(self):
        ...
        now = datetime.datetime.now()
        db_utils.set_last_crawled_in_user(this_user.user_id, now, 2) 
...
class TestAddRepo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.holder_is_repo_in_db = db_utils.is_repo_in_db
    ...
    def tearDown(self):
        ...
        db_utils.is_repo_in_db = self.holder_is_repo_in_db

    # def test_add_repo_existing(self):
    #     db_utils.is_repo_in_db = lambda repo_id: True

    #     self.assertEqual(0, utils.add_repo(2))

    # def test_add_repo_new(self):
    #     db_utils.is_repo_in_db = lambda repo_id: False
    ...
    def test_is_repo_in_db_true(self):
        self.assertEqual(True, db_utils.is_repo_in_db(2))

    def test_is_repo_in_db_false(self):
        # import pdb; pdb.set_trace()
        self.assertEqual(False, db_utils.is_repo_in_db(9))
...
class TestAddUser(unittest.TestCase):
    ...
    #     db_utils.is_user_in_db = lambda user_id: True

    #     self.assertEqual(0, utils.add_user(2))

    # def test_add_user_new(self):
    #     db_utils.is_user_in_db = lambda user_id: False
    ...
    def test_is_user_in_db_true(self):
        self.assertEqual(True, db_utils.is_user_in_db(4))

    def test_is_user_in_db_false(self):
        # import pdb; pdb.set_trace()
        self.assertEqual(False, db_utils.is_user_in_db(9))
